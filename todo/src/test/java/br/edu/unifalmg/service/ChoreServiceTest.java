...
public class ChoreServiceTest {
    ...
    void printChoresWhenTheListIsEmptyPrintNoChoresToDisplay() {
        ChoreService service = new ChoreService();
        assertEquals("No chores to display",service.displayChores());
    }
    ...
    void printChoresWhenTheListHasOneChoreAndItHasCompletedStatusPrintTheInformationAboutTheChore() {
        ChoreService service = new ChoreService();
        service.addChore("Escrever teste",LocalDate.of(2023,9,29));
        service.getChores().get(0).setIsCompleted(true);
        assertEquals("Descrição: “Escrever teste” Deadline: 29/09/2023 Status: Completa",service.displayChores());
    }
    ...
    void printChoresWhenTheListHasOneChoreAndItHasUncompletedStatusPrintTheInformationAboutTheChore() {
        ChoreService service = new ChoreService();
        service.addChore("Escrever teste",LocalDate.of(2023,9,29));
        assertEquals("Descrição: “Escrever teste” Deadline: 29/09/2023 Status: Incompleta",service.displayChores());
    }
    ...
    void printChoresWhenTheListHasMoreThanOneChorePrintTheInformationAboutTheChores() {
        ...
        assertAll(
                () -> assertEquals("Descrição: “Escrever teste” Deadline: 29/09/2023 Status: Completa", service.displayChores()),
                () -> assertEquals("Implementar código” Deadline: 12/10/2023 Status: Incompleta", service.displayChores())
        );
    }
